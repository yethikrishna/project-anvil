...
export type ActionExecutorFn = (params: Record<string, any>) => Promise<any>;
export type RollbackFn = (params: Record<string, any>, result: any) => Promise<void | Record<string, any>>;
